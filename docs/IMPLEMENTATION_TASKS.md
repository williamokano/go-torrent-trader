...
#### BE-8.18: Harden the Admin Stats Write Path + Audit Durability [M]
**As a** site operator
...
#### BE-8.19: Cleanup Worker Hard-Deletes Banned Accounts [S] [BUG]
**As a** site operator
...
#### BE-9.23: Restrict Sensitive Activity Log Entries to Staff [S] [BUG] [DONE]
**As a** tracker operator
