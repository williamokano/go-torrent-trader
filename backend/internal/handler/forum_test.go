...
func (m *mockHandlerForumPostRepo) GetByID(_ context.Context, _ int64) (*model.ForumPost, error) {
	return nil, nil
}
func (m *mockHandlerForumPostRepo) ListByTopic(_ context.Context, _ int64, _, _ int) ([]model.ForumPost, int64, error) {
	return nil, 0, nil
}
func (m *mockHandlerForumPostRepo) Create(_ context.Context, post *model.ForumPost) error {
	post.ID = 1
...
func (m *mockHandlerForumPostRepo) Search(_ context.Context, _ string, _ *int64, _ int, _, _ int) ([]model.ForumSearchResult, int64, error) {
	return nil, 0, nil
}
func (m *mockHandlerForumPostRepo) GetFirstPostIDByTopic(_ context.Context, _ int64) (int64, error) {
	return 0, nil
}
...
func (m *mockHandlerForumPostRepo) CreateEdit(_ context.Context, _ *model.ForumPostEdit) error {
	return nil
}
func (m *mockHandlerForumPostRepo) ListEdits(_ context.Context, _ int64) ([]model.ForumPostEdit, error) {
	return nil, nil
}
...
func TestHandleCreateTopic_BadJSON(t *testing.T) {
	...
	if resp["error"].(map[string]interface{})["code"] != "bad_request" {
		t.Error("expected bad_request")
	}
}
