...
func run() int {
	...
	announceRollupRepo := postgres.NewAnnounceRollupRepo(db)
	...
	inviteDistributionRepo := postgres.NewInviteDistributionRepo(db)
	inviteDistributionService := service.NewInviteDistributionService(inviteDistributionRepo, groupRepo, userRepo, siteSettingsService, eventBus)
