...
func PostgreSQL() Schema {
	return Schema{tables: map[string][]string{
		...
		"torrents":                 {"anonymous", "approved_at", "approved_by", "assigned_moderator_id", "banned", "category_id", "comments_count", "created_at", "description", "file_count", "files", "free", "hnr_exempt", "id", "info_hash", "leechers", "metadata", "moderation_status", "name", "nfo", "search_vector", "seeders", "silver", "size", "times_completed", "updated_at", "uploader_id", "visible"},
